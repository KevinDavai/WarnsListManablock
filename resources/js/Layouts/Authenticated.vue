      ...
      <nav class="nav">
        <div>
          <div class="nav_list">
            ...
            <inertia-link :href="route('dashboard.doubleacc')" class="nav_link"
              :class="urlPath == '/double-compte' ? 'active-app' : '' ">
        ...
        </div> <a :href="route('admin.dashboard.index')" v-if="$page.props.auth.user.role_id == 3" class="nav_link"> <i
            class="fas fa-user-lock"></i> <span class="nav_name">Panel Administrateur</span> </a>
      </nav>
    </div>
    <nav class="navbar p-0 transition-navbar bg-navbar-deg navbar-expand navbar-light bg-purple-me sticky-top">
      <div class="header_toggle ml-4 ml-md-0"><i class="fas fa-bars min-width-24" @click="sideBar" id="header-toggle"
      ...
      <div class="container container-pd">
        ...
        <div class="collapse navbar-collapse justify-content-center width-²-back" id="navbarSupportedContent">
          ...
          <ul class="d-none d-sm-block navbar-nav align-items-baseline">
            ...
            <a @click="logout" as="button" class="back-btn"><i class="fas fa-sign-out-alt d-none d-sm-inline-block"></i>
