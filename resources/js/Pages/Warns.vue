<template>
  ...
  <breeze-authenticated-layout>
    ...
    <a v-if="$page.props.auth.user.role_id != 1" as="button" class="add-btn" data-bs-toggle="modal"
      data-bs-target="#addWarnModal"><i class="fas fa-plus"></i></a>
    ...
    <div class="container mt-2">
      ...
      <div class="row justify-content-around px-4">
        <div
          ...
          <div class="form-label-group mb-3">
            <Datepicker id="floatingLabelDate" :position="null" :range="true" lang="fr" :circle="true"
              v-model="this.date" :date-format="dateFormat" showClearButton='true' @reset='test' />
          </div>
        </div>
        <div
      ...
      <div class="table-responsive-xl">
          ...
          <thead>
            <tr>
              ...
              <th class="col-1 p-top-table"><span class="ms-2">Date</span></th>
            </tr>
          </thead>
          <tbody>
      ...
      <nav class="px-0 px-sm-4 pb-0 pb-sm-4 pb-3">
        <ul class="p-0" style="display: flex; margin: 0px; justify-content: space-between;">
          <li>
            <button @click="setPreviousPage" v-if="this.index != 0" type="button" class="left-page-btn"><i
                class="fas fa-angle-left"></i></button>
          </li>
          <li>
            <button @click="setNextPage" v-if="this.index < this.computedWarns.length - 5" type="button"
              class="right-page-btn"><i class="fas fa-angle-right"></i></button>
          </li>
        </ul>
      </nav>
    </div>
