        ...
        <div class="row w-100">
            <div class="col-12">
                <div class="page-title-box w-100">
                    <h4 class="page-title text-white">Rondes</h4>
                </div>
            </div>
        </div>
        <a
        ...
        <div class="container mt-2">
            ...
            <div class="table-responsive-xl">
                ...
                >
                    ...
                    <tbody>
                        <tr
                            v-for="(ronde, index) in computedRondes.slice(
                                index,
                                index + 7
                            )"
                        >
                    ...
                    >
                        ...
                        <li>
                            <button
                                @click="setNextPage"
                                v-if="
                                    this.index < this.computedRondes.length - 5
                                "
                                type="button"
...
export default {
    ...
    mounted() {
        ...
        var vm = this;
        var pusher = new Pusher("db16405c6f87dc23e836", {
            cluster: "eu",
        });
