        ...
        <div class="row w-100">
            <div class="col-12">
                <div class="page-title-box w-100">
                    <h4 class="page-title text-white">Doubles Comptes</h4>
                </div>
            </div>
        </div>
        <a
            ...
            data-bs-target="#addDoubleCompte"
                ...
                >
                    ...
                    <tbody>
                        <tr
                            ...
                            v-for="(
                                doubleAcc, index
                            ) in computedDoubleAcc.slice(index, index + 7)"
                        >
                            <td>
                                <div
                                    style="height: 28px"
                                ...
                                >
                                    <i
                                        class="fas fa-angle-down color-primary-me fa-lg"
                                    ></i>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="align-middle">
                                <div
                                    :class="{
                                        'text-nowrap':
                                            doubleAcc.description.length >= 60,
                                    }"
                                >
                                    {{ doubleAcc.description }}
                                </div>
                            </td>
                            <td class="align-middle">
                    ...
                    >
                        ...
                        <li>
                            <button
                                ...
                                v-if="
                                    this.index <
                                    this.computedDoubleAcc.length - 5
                                "
                                type="button"
...
export default {
    ...
    computed: {
        computedDoubleAcc: function () {
            ...
            return this.doubleAccList.filter((item) => {
                var lower = [];
                for (let i = 0; i <= 5; i++) {
                    if (item.pseudo[i] === undefined) lower.push("");
                    else lower.push(item.pseudo[i].toLowerCase());
                }
                console.log(lower);
    ...
    methods: {
        ...
        isMultiple(index) {
            if (this.computedDoubleAcc[index].pseudo.length > 2)
                console.log(index + " OUI");
            return true;
            return false;
        },
        list(page) {
            axios
                .get(`/doubleAccList?page=${page}`)
                .then(({ data }) => {
